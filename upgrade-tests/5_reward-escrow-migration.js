...
const checktotalEscrowedAccountBalanceBeforeMigration = async () => {
    ...
    try {
        ...
        fs.writeFileSync('files/totalEscrowedAccountBalances.json', JSON.stringify(totalEscrowedAccountBalances), err => {
            if (err) {
                throw err;
            }
        })
...
const checktotalVestedAccountBalanceBeforeMigration = async () => {
    ...
    try {
        ...
        fs.writeFileSync('files/totalVestedAccountBalances.json', JSON.stringify(totalVestedAccountBalances), err => {
            if (err) {
                throw err;
            }
        })
